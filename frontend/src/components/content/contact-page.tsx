      ...
      <div className={styles.shell}>
        <header className={styles.hero}>
          <FadeIn delay={0.05} direction="up" distance={12}>
            <div>
              ...
              <h1>Contacto</h1>
              <p>Elige el motivo de tu mensaje para orientar consultas, propuestas, alianzas o soporte.</p>
            </div>
          </FadeIn>
          <span className={styles.heroIcon}><MessageSquareText aria-hidden="true" /></span>
        </header>
        ...
        <section className={styles.section}>
          ...
          <StaggerContainer className={styles.grid} staggerDelay={0.06}>
            <StaggerItem>
              <article className={`${styles.item} transition-all duration-200 hover:-translate-y-1 hover:shadow-md`}>
                <MessageSquareText aria-hidden="true" />
                <h3>Consultas generales</h3>
                <p>Información sobre actividades y contenidos publicados.</p>
              </article>
            </StaggerItem>
            <StaggerItem>
              <article className={`${styles.item} transition-all duration-200 hover:-translate-y-1 hover:shadow-md`}>
                <UsersRound aria-hidden="true" />
                <h3>Propuestas estudiantiles</h3>
                <p>Problemas, ideas o solicitudes para representación.</p>
              </article>
            </StaggerItem>
            <StaggerItem>
              <article className={`${styles.item} transition-all duration-200 hover:-translate-y-1 hover:shadow-md`}>
                ...
                <p>Coordinaciones con organizaciones y aliados.</p>
              </article>
            </StaggerItem>
            <StaggerItem>
              <article className={`${styles.item} transition-all duration-200 hover:-translate-y-1 hover:shadow-md`}>
                <Headphones aria-hidden="true" />
                <h3>Soporte para inscripciones</h3>
                <p>Ayuda relacionada con eventos que tengan registro activo.</p>
              </article>
            </StaggerItem>
          </StaggerContainer>
        </section>
        ...
        <div className={styles.split}>
          <Reveal className={styles.panel} delay={0.08}>
            <h2>Canales publicados</h2>
            <div className={styles.contactCards}>
              <article className={`${styles.contactCard} transition-transform duration-200 hover:translate-x-1`}>
                <Mail aria-hidden="true" />
                <div>
                  <h3>Correo</h3>
                  <a href="mailto:somos.fuerzaupt@gmail.com">somos.fuerzaupt@gmail.com</a>
                </div>
              </article>
              <article className={`${styles.contactCard} transition-transform duration-200 hover:translate-x-1`}>
                ...
                <div>
                  <h3>Ubicación</h3>
                  <p>Universidad Privada de Tacna, Campus Capanique, Tacna</p>
                </div>
              </article>
              <article className={`${styles.contactCard} transition-transform duration-200 hover:translate-x-1`}>
          ...
          <Reveal className={styles.panel} delay={0.12}>
            ...
            <form className={styles.form} action="mailto:somos.fuerzaupt@gmail.com" method="post" encType="text/plain">
              <div className={styles.field}><label htmlFor="contact-name">Nombre</label><input id="contact-name" name="Nombre" required className="transition-all duration-200 focus:ring-2 focus:ring-blue-100" /></div>
              <div className={styles.field}><label htmlFor="contact-email">Correo</label><input id="contact-email" name="Correo" type="email" required className="transition-all duration-200 focus:ring-2 focus:ring-blue-100" /></div>
              ...
              <div className={`${styles.field} ${styles.wide}`}><label htmlFor="contact-message">Mensaje</label><textarea id="contact-message" name="Mensaje" required className="transition-all duration-200 focus:ring-2 focus:ring-blue-100" /></div>
              <p className={styles.formNote}>El formulario abrirá tu aplicación de correo. No almacenamos estos datos en la web.</p>
              <button className={`${styles.submit} transition-all duration-200 hover:scale-105 active:scale-95`} type="submit"><Send aria-hidden="true" />Enviar por correo</button>
            </form>
          </Reveal>
        </div>
      </div>
